 ...
 * From these assumptions, we can run a full DiscretePredictionComparator.
 */
public class DiscreteAccuracyInspector implements ReasonerInspector {
	private static final Logger log = LoggerFactory.getLogger(ReasonerInspector.class);
	 ...
	 */
	private Database getRandomVariableDatabase() {
	 ...
	 */
	private Database getTruthDatabase(Database rvDatabase) {
