...
public enum AtomEvent {
	...
	/**
	 * @return the GroundKernelStore to which any GroundKernels generated by
	...
	/**
	 * Sets a GroundKernelStore to which any GroundKernels generated by this
	 * event should be added.
	 * 
	 * @param app  the GroundKernelStore to set
	 * @return this event, for convenience
	 */
	public AtomEvent setGroundKernelStore(GroundKernelStore gks) {
		this.gks = gks;
		return this;
	}
}
