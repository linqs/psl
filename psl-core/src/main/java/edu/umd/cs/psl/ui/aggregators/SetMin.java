...
public class SetMin implements EntityAggregatorFunction {
	...
	public SetMin(double multiplier, double emptySet, double threshold) {
		supportThreshold = threshold;
		emptySetSim = emptySet;
		this.multiplier = multiplier;
	}
	
	public SetMin(double multiplier) {
