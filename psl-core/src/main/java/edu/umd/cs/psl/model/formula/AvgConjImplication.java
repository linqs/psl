 ...
 */
public class AvgConjImplication implements Formula {

	protected final Formula ACImplicationFormula;
	...
	public AvgConjImplication(Formula ACImplicationFormula) {
		assert ACImplicationFormula!=null;
		this.ACImplicationFormula = ACImplicationFormula;
		...
		assert ACImplicationFormula instanceof Implication;
		Implication implicationRule = (Implication) ACImplicationFormula;
		...
		for (int c = 0; c < bodyFormulae.length; c++) {
			...
			} else throw new IllegalStateException("body of average conjunction implication not of a recognized type.");
		}
		...
		for (int d = 0; d < headFormulae.length; d++) {
			...
			} else throw new IllegalStateException("head of average conjunction implication not of a recognized type.");
		}
	...
	public int hashCode() {
		...
		return ACImplicationFormula.hashCode();
	}
	...
	public boolean equals(Object oth) {
		...
		AvgConjImplication of = (AvgConjImplication)oth;
		return ACImplicationFormula.equals(of.ACImplicationFormula);
	}
	
	@Override
	public String toString() {
		//TODO print weighted DNF
		return ACImplicationFormula.toString();
	}
