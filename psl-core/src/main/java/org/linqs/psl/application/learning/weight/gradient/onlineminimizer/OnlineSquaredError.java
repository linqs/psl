 ...
 */
public class OnlineSquaredError extends OnlineMinimizer {
    public OnlineSquaredError(List<Rule> rules, Database trainTargetDatabase, Database trainTruthDatabase,
