...
public class DualBCDReasoner extends Reasoner<DualLCQPObjectiveTerm> {
    ...
    public double optimize(TermStore<DualLCQPObjectiveTerm> baseTermStore, List<EvaluationInstance> evaluations, TrainingMap trainingMap) {
        ...
        while(!breakDualBCD) {
            ...
            breakDualBCD = breakOptimization(iteration, termStore, objective, oldObjective);

            log.trace("Iteration {} -- Objective: {}, Violated Constraints: {}, Iteration Time: {}, Total Optimization Time: {}.",
                    iteration, objective.objective, objective.violatedConstraints, (end - start), totalTime);
