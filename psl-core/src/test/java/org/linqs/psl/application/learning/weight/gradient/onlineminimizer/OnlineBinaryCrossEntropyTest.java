...
public class OnlineBinaryCrossEntropyTest extends WeightLearningTest {
    @Before
    public void setup() {
        super.setup();
    ...
    protected WeightLearningApplication getBaseWLA() {
        return new OnlineBinaryCrossEntropy(info.model.getRules(), trainTargetDatabase, trainTruthDatabase,
