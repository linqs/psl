...
import org.linqs.psl.application.learning.weight.em.PairedDualLearner;
...
public class PairedDualLearnerTest {
	...
	public void baseTest() {
		WeightLearningApplication weightLearner = new PairedDualLearner(info.model.getRules(), weightLearningTrainDB, weightLearningTruthDB, info.config);
		weightLearner.learn();
		weightLearner.close();
	}
