...
public class OnlineSquaredErrorTest extends WeightLearningTest {
    @Before
    public void setup() {
        super.setup();
    ...
    protected WeightLearningApplication getBaseWLA() {
        return new OnlineSquaredError(info.model.getRules(), trainTargetDatabase, trainTruthDatabase,
