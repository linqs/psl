...
public class AUCEvaluatorTest extends EvaluatorTest<AUCEvaluator> {
    ...
    public void testReference() {
        ...
        evaluator.compute(trainingMap, predicate);
        assertEquals(0.510417, evaluator.auroc(), MathUtils.EPSILON);
        assertEquals(0.359771, evaluator.positiveAUPRC(), MathUtils.EPSILON);
        assertEquals(0.714468, evaluator.negativeAUPRC(), MathUtils.EPSILON);
        ...
        init(predictions, truth);
        evaluator.compute(trainingMap, predicate);
        assertEquals(0.659341, evaluator.auroc(), MathUtils.EPSILON);
        assertEquals(0.735122, evaluator.positiveAUPRC(), MathUtils.EPSILON);
        assertEquals(0.282618, evaluator.negativeAUPRC(), MathUtils.EPSILON);
        ...
        init(predictions, truth);
        evaluator.compute(trainingMap, predicate);
        assertEquals(0.434343, evaluator.auroc(), MathUtils.EPSILON);
        assertEquals(0.477349, evaluator.positiveAUPRC(), MathUtils.EPSILON);
        assertEquals(0.564365, evaluator.negativeAUPRC(), MathUtils.EPSILON);
        ...
        init(predictions, truth);
        evaluator.compute(trainingMap, predicate);
        assertEquals(0.619048, evaluator.auroc(), MathUtils.EPSILON);
        assertEquals(0.452831, evaluator.positiveAUPRC(), MathUtils.EPSILON);
        assertEquals(0.628401, evaluator.negativeAUPRC(), MathUtils.EPSILON);
        ...
        init(predictions, truth);
        evaluator.compute(trainingMap, predicate);
        assertEquals(0.488095, evaluator.auroc(), MathUtils.EPSILON);
        assertEquals(0.785729, evaluator.positiveAUPRC(), MathUtils.EPSILON);
        assertEquals(0.275980, evaluator.negativeAUPRC(), MathUtils.EPSILON);
        ...
        init(predictions, truth);
        evaluator.compute(trainingMap, predicate);
        assertEquals(0.450000, evaluator.auroc(), MathUtils.EPSILON);
        assertEquals(0.427871, evaluator.positiveAUPRC(), MathUtils.EPSILON);
        assertEquals(0.650216, evaluator.negativeAUPRC(), MathUtils.EPSILON);
        ...
        init(predictions, truth);
        evaluator.compute(trainingMap, predicate);
        assertEquals(0.535354, evaluator.auroc(), MathUtils.EPSILON);
        assertEquals(0.538568, evaluator.positiveAUPRC(), MathUtils.EPSILON);
        assertEquals(0.500034, evaluator.negativeAUPRC(), MathUtils.EPSILON);
        ...
        init(predictions, truth);
        evaluator.compute(trainingMap, predicate);
        assertEquals(0.571429, evaluator.auroc(), MathUtils.EPSILON);
        assertEquals(0.775731, evaluator.positiveAUPRC(), MathUtils.EPSILON);
        assertEquals(0.258924, evaluator.negativeAUPRC(), MathUtils.EPSILON);
        ...
        init(predictions, truth);
        evaluator.compute(trainingMap, predicate);
        assertEquals(0.540000, evaluator.auroc(), MathUtils.EPSILON);
        assertEquals(0.664196, evaluator.positiveAUPRC(), MathUtils.EPSILON);
        assertEquals(0.439707, evaluator.negativeAUPRC(), MathUtils.EPSILON);
        ...
        init(predictions, truth);
        evaluator.compute(trainingMap, predicate);
        assertEquals(0.505051, evaluator.auroc(), MathUtils.EPSILON);
        assertEquals(0.500027, evaluator.positiveAUPRC(), MathUtils.EPSILON);
        assertEquals(0.617837, evaluator.negativeAUPRC(), MathUtils.EPSILON);
        ...
        init(predictions, truth);
        evaluator.compute(trainingMap, predicate);
        assertEquals(0.670330, evaluator.auroc(), MathUtils.EPSILON);
        assertEquals(0.698193, evaluator.positiveAUPRC(), MathUtils.EPSILON);
        assertEquals(0.377438, evaluator.negativeAUPRC(), MathUtils.EPSILON);
        ...
        init(predictions, truth);
        evaluator.compute(trainingMap, predicate);
        assertEquals(0.444444, evaluator.auroc(), MathUtils.EPSILON);
        assertEquals(0.471122, evaluator.positiveAUPRC(), MathUtils.EPSILON);
        assertEquals(0.574506, evaluator.negativeAUPRC(), MathUtils.EPSILON);
        ...
        init(predictions, truth);
        evaluator.compute(trainingMap, predicate);
        assertEquals(0.616162, evaluator.auroc(), MathUtils.EPSILON);
        assertEquals(0.679391, evaluator.positiveAUPRC(), MathUtils.EPSILON);
        assertEquals(0.363322, evaluator.negativeAUPRC(), MathUtils.EPSILON);
        ...
        init(predictions, truth);
        evaluator.compute(trainingMap, predicate);
        assertEquals(0.545455, evaluator.auroc(), MathUtils.EPSILON);
        assertEquals(0.440478, evaluator.positiveAUPRC(), MathUtils.EPSILON);
        assertEquals(0.606677, evaluator.negativeAUPRC(), MathUtils.EPSILON);
        ...
        init(predictions, truth);
        evaluator.compute(trainingMap, predicate);
        assertEquals(0.575758, evaluator.auroc(), MathUtils.EPSILON);
        assertEquals(0.549080, evaluator.positiveAUPRC(), MathUtils.EPSILON);
        assertEquals(0.491238, evaluator.negativeAUPRC(), MathUtils.EPSILON);
        ...
        init(predictions, truth);
        evaluator.compute(trainingMap, predicate);
        assertEquals(0.737374, evaluator.auroc(), MathUtils.EPSILON);
        assertEquals(0.738097, evaluator.positiveAUPRC(), MathUtils.EPSILON);
        assertEquals(0.326252, evaluator.negativeAUPRC(), MathUtils.EPSILON);
        ...
        init(predictions, truth);
        evaluator.compute(trainingMap, predicate);
        assertEquals(0.780220, evaluator.auroc(), MathUtils.EPSILON);
        assertEquals(0.824571, evaluator.positiveAUPRC(), MathUtils.EPSILON);
        assertEquals(0.486957, evaluator.negativeAUPRC(), MathUtils.EPSILON);
        ...
        init(predictions, truth);
        evaluator.compute(trainingMap, predicate);
        assertEquals(0.281250, evaluator.auroc(), MathUtils.EPSILON);
        assertEquals(0.461711, evaluator.positiveAUPRC(), MathUtils.EPSILON);
        assertEquals(0.701329, evaluator.negativeAUPRC(), MathUtils.EPSILON);
        ...
        init(predictions, truth);
        evaluator.compute(trainingMap, predicate);
        assertEquals(0.484848, evaluator.auroc(), MathUtils.EPSILON);
        assertEquals(0.453849, evaluator.positiveAUPRC(), MathUtils.EPSILON);
        assertEquals(0.572165, evaluator.negativeAUPRC(), MathUtils.EPSILON);
        ...
        init(predictions, truth);
        evaluator.compute(trainingMap, predicate);
        assertEquals(0.479167, evaluator.auroc(), MathUtils.EPSILON);
        assertEquals(0.371452, evaluator.positiveAUPRC(), MathUtils.EPSILON);
        assertEquals(0.689192, evaluator.negativeAUPRC(), MathUtils.EPSILON);
    }
}
